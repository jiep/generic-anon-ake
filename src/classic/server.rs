...
use super::{client::Client, sig::sig_gen};

#[derive(Debug)]
pub struct Server {
    clients_keys: Vec<(ecies::PublicKey, ecies::SecretKey)>,
    kem_keys: HashMap<u32, (ecies::PublicKey, ecies::SecretKey)>,
...
impl Server {
    ...
    pub fn set_kem_keypair(&mut self, keys: (ecies::PublicKey, ecies::SecretKey), index: u32) {
