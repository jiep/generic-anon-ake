...
pub fn vrf_keypair(seed: &[u8; 32], param: &Param) -> (lb_vrf::keypair::PublicKey, lb_vrf::keypair::SecretKey) {
...
pub fn vrf_serialize_pi(p: &Proof) -> (Vec<u8>, [Vec<u8>; 9]) {
    ...
    let mut buf_z: [Vec<u8>; 9] = [Vec::new(), Vec::new(), Vec::new(), Vec::new(), Vec::new(), Vec::new(), Vec::new(), Vec::new(), Vec::new()];
