...
pub fn pke_enc(pk: &Point<NonNormal>, m: Vec<u8>, r: Vec<u8>) -> (Point<secp256kfun::marker::NonNormal, Public, secp256kfun::marker::Zero>, Point<secp256kfun::marker::NonNormal, Public, secp256kfun::marker::Zero>) {
